...
method_results = tb.open_file(state_saving_path + 'CosineKmeans_3C_7Genres_50%.h5', 'a')
...
params_range = coll.OrderedDict([
   ...
   ('vocab_size', [10, 50, 500, 1000, 5000, 10000, 50000, 100000]),  # 10, 50, 500,
   ('max_iter', [30, 100, 300]),
   ('converg_diff', [0.0005, 0.001, 0.005, 0.01, 0.05, 0.1, 0.5]),  # 0.0005,
   ('learing_rate', [0.0001])  # 0.0003, , 0.01, 0.03, 0.1, 0.3 0.003
])
