...
kfolds_vocs_filepath =
"/home/dimitrios/Synergy-Crawler/Santinis_7-web_genre/Kfolds_Vocs_Inds_1Words_7Genres"
genres = ["blog", "eshop", "faq", "frontpage", "listing", "php", "spage"]
test_only_tgs = False
method_results = tb.open_file(
    '/home/dimitrios/Synergy-Crawler/Santinis_7-web_genre/OCSVM_1Words_7Genres.h5', 'w'
)
...
results_h5 = pgrid_corssv.evaluate(
    html_file_l, cls_gnr_tgs, test_only_tgs, None, params_range, 'utf-8'
)
