...
test_only_tgs = [12]
method_results = tb.openFile('/home/dimitrios/Synergy-Crawler/SANTINIS/RFSE_4Chars_SANTINIS_minmax.h5', 'w')
...
ml_model = RFSE_Wrapped(minmax_similarity, 0.0, genres[0:-1], bagging=False)
