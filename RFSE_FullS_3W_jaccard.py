...
kfolds_vocs_filepath = "/home/dimitrios/Synergy-Crawler/SANTINIS/Kfolds_Vocs_Inds_3Words_SANTINI"
...
test_only_tgs = [12]
method_results = tb.openFile('/home/dimitrios/Synergy-Crawler/SANTINIS/RFSE_3Words_SANTINIS_jaccard.h5', 'w')
...
ml_model = RFSE_Wrapped(jaccard_similarity_binconv, 0.0, genres[0:-1], bagging=False)
